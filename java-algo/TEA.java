...
// $Revision: 1.5 $, $Date: 2003/04/29 00:10:39 $
...
public class TEA {
    ...
    public TEA(int[] k) { this(k[0], k[1], k[2], k[3]); }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 5 ||
            ...
            System.err.println(
                    "To encipher: java TEA e key0 key1 key2 key3 <in >out"
                );
            System.err.println(
                    "To decipher: java TEA d key0 key1 key2 key3 <in >out"
                );
            return;
        }
        int[] keys = new int[4];
