...
public class PermutationGenerator {
    ...
    public static void main(String[] args) {
        System.out.println("方法 1");  PermutationGenerator1.generate(4);
        System.out.println("方法 2");  PermutationGenerator2.generate(4);
        System.out.println("方法 3");  PermutationGenerator3.generate(4);
        System.out.println("方法 4");  PermutationGenerator4.generate(4);
    }
}
