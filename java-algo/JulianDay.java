 ...
 *  ユリウス日
 *
 *  @version $Revision: 1.22 $, $Date: 2003/04/28 23:23:16 $
 */
...
public class JulianDay {
    ...
    public JulianDay(int    jd) {  toDate(jd);  }
    public JulianDay(double jd) {  toDate(jd);  }
    ...
    /** 暦日からユリウス日に変換 */
    public static double toNumber(int year, int month, int day,
    ...
    final static DecimalFormat df1 = new DecimalFormat(" 0000;-");
    final static DecimalFormat df2 = new DecimalFormat("00");
    final static DecimalFormat df3 = new DecimalFormat("00.000");
    ...
    public static void main(String[] args) throws IOException {
        ...
        JulianDay jd = new
            JulianDay(JulianDay.toNumber(year, month, day) + offset);
        System.out.println(jd.year + "年" + jd.month + "月"
                           + jd.day + "日です．");
    }
}
