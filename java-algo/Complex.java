 ...
 *
 *  @version $Revision: 1.8 $, $Date: 2003/03/13 14:24:30 $
 */
public class Complex {
    ...
    public Complex(Complex that) {
        if (that != null) { real = that.real; imag = that.imag; }
    }
    /**
    ...
    public boolean equals(Object rhs) {
        ...
        if (rhs instanceof Complex)
            return (real == ((Complex)rhs).real &&
                    imag == ((Complex)rhs).imag);
        return false;
    }
    /**
     *  実数部を返します。
     ...
     *  @return this<sup>*</sup>
     */
    public Complex conj() { return new Complex(real,-imag); }
    /**
     *  -1 倍
     *  @return -this
     */
