...
public class Newton2 {
    ...
    static final DecimalFormat DF15 = new
        DecimalFormat(" 0.000000000000000E00;-0.000000000000000E00");
    ...
    public static double solve(Function f, double x) { // 
        ...
        while (fx != 0) {
            ...
            do {
                x = xPrev - h;  fx = f.of(x);  h /= 2;  i++;
                System.out.println("(" + i + ") x = " + DF15.format(x)
                                   + "  f(x) = " + DF2.format(fx));
