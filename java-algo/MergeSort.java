 ...
 *  マージソート
 *
 *  @version $Revision: 1.9 $, $Date: 2003/04/28 23:23:17 $
 */

public class MergeSort {
    static class Sortee {
        int key, info;
        public Sortee(int k, int i) { key = k; info = i; }
        public String toString() { return key + ":" + info; }
    }
    ...
    /** a[first..last-1] を昇順に */
    private static void sort(Sortee a[],
                             int first, int last, Sortee work[]) {
