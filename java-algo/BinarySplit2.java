...
* 再帰版。
* @version $Revision: 1.1 $, $Date: 2003/03/20 02:30:36 $
*/
import java.math.*;     // BigInteger と BigDecimal クラスを使う。
...
public abstract class BinarySplit2 {
    private final int A = 0, B = 1, C = 2;  // enum{} の代用。
    private int L, N;
    BigDecimal X[], result;
    /**
    * 10 進での精度（有効桁数）を返します。
