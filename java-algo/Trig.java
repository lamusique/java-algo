public class Trig extends FuncViewer {
    private static class Ur_Tan { // tan x の素(本文参照)
        static int N = 19;
        static double D = 4.4544551033807686783083602485579E-6;
        int k; double t;
        Ur_Tan(double x) {
    ...
    public static double cos1(double x) { // 1 - cos x
    ...
    public String getName() { return "tan(x)"; }
    public double getValue(double x) { return tan(x); }
}
