/*
* FFTMult.java -- FFT 乗算
* @version $Revision: 1.7 $, $Date: 2003/01/26 05:45:34 $
...
*/
    public static void main(String[] args) throws IOException {
        ...
        if (fig <= 0) {
            System.err.println("正の数値を入力してください。"); System.exit(-1);
        }
        SInteger siA = new SInteger(fig);
        SInteger siB = new SInteger(fig);
        SInteger siC = new SInteger(0);
        ...
        System.out.println("result of getValue(a, b) =");    siC.print();
