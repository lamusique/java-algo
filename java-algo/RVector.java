 ...
 *
 *  @version $Revision: 1.6 $, $Date: 2003/03/13 14:24:35 $
 */
public class RVector {
     ...
     *  @return 内積の値
     */
    public static double innerProduct(int ns, int ne,
                                      double[] lhs, double[] rhs) {
        if (ns < 0 || ne < 0 || ns > ne) throw new IndexOutOfBoundsException("error in RVector\n");
        double  s = 0.0;
        int n5 = (ne - ns) % 5;
