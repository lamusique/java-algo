 ...
 *
 * @version $Revision: 1.5 $, $Date: 2003/03/04 09:20:46 $
 */
...
class EulerMethod {
    ...
    public static double solve(Function f, int n, int nPrint,
...
public class OrdinaryDiffEq {
    /** $y' = 1 - y^2$ */
    static class Function implements EulerMethod.Function,
                                     Taylor3.Function, RungeKutta4.Function {
