public class Exp extends FuncViewer {
    private static double
        LOG2 = 0.6931471805599453094172321214581765680755; // log_e 2
    ...
    private static int N = 22; // 本文参照（6，10，14，18，22，26，...）
    ...
    public String getName() { return "exp(x)"; }
    public double getValue(double x) { return exp1(x); }
}
