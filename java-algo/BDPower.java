...
* @version $Revision: 1.11 $, $Date: 2003/03/31 14:19:26 $
*/
import java.math.*;
...
public class BDPower {
    ...
    */
    public static BigDecimal power(BigDecimal x, int n, int precision) {
        ...
        if (n < 0) { x = reciprocal(x, precision);  n = -n; }
        while (n != 0) {
    ...
    */
    public static void reciprocalTest(int precision) {
        ...
        for (int n = -3; n <= 3; n++) {
            ...
            d = x.multiply(y);  d = d.subtract(BDTools.ONE);
    ...
    public static void main(String[] args) {
        ...
        for (int n = -3; n <= 3; n++) {
            ...
            System.out.print("y = x^(" + n + ")= ");    BDTools.print(y, 10, false);
