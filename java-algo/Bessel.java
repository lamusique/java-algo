public class Bessel extends FuncViewer {
    private static double EPS = 1e-10; // 許容相対誤差
    private static double EULER = 0.577215664901532861; // Euler の定数γ
    ...
    public String getName() { return "J_3(x)"; }
    public double getValue(double x) { return J(3, x); }
}
